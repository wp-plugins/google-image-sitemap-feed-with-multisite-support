...
function xml_sitemap_image_enlaces($enlaces, $archivo) {
	...
	if ($archivo == $plugin) 
	{
		...
		$enlaces[] = '<a href="' . $xml_image_sitemap['donacion'] . '" target="_blank" title="' . __('Make a donation by ', 'xml_image_sitemap') . 'APG"><span class="icon-bills"></span></a>';
